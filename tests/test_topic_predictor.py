...
def test_evaluate_topic_predictions_excludes_none_from_denominator():
    ...
    sampled = [
        ...
        {"id": "2", "title": "t", "country": "germany", "topic": "sports", "predicted_topic": None},
    ]
    result = topic_predictor.evaluate_topic_predictions(sampled)
